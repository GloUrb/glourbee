...
class MultiPageApp:
    ...
    def run(self):
        st.session_state['current_directory'] = Path(__file__).parent
        ...
        st.image(os.path.join(current_directory, 'lib/img/skeleton.svg'),  use_column_width=True, width=500)
        ...
        st.image(os.path.join(current_directory, 'lib/img/authentication.svg'),  use_column_width=True, width=500)
        ...
        st.image(os.path.join(current_directory, 'lib/img/dgo1.svg'),  use_column_width=True, width=500)
        ...
        st.image(os.path.join(current_directory, 'lib/img/dgo2.svg'),  use_column_width=True, width=500)
        ...
        st.image(os.path.join(current_directory, 'lib/img/dgo3.svg'),  use_column_width=True, width=500)
        st.write('Your dgos should also be displayed on the map')
        st.image(os.path.join(current_directory, 'lib/img/dgo4.svg'),  use_column_width=True, width=500)
        
        st.title('Choose metrics page')
        st.write('Here you can first choose the parameters of the images you want to exploit.')
        st.image(os.path.join(current_directory, 'lib/img/metrics3.svg'),  use_column_width=True, width=500)
        st.image(os.path.join(current_directory, 'lib/img/metrics1.svg'),  use_column_width=True, width=500)
        ...
        st.image(os.path.join(current_directory, 'lib/img/metrics4.svg'),  use_column_width=True, width=500)
        st.image(os.path.join(current_directory, 'lib/img/metrics2.svg'),  use_column_width=True, width=500)
